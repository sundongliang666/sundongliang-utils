...
//		boolean number = stringUtils.isNumber("1");
//		System.out.println("number is "+number);
//		Assert.assertTrue(number==false);
//	}
//	
//	/**
//	 * 测试手机号是否正确
...
//		boolean telephoneIsOk = stringUtils.judgeTelephoneIsOk("25839235683");
//		//验证手机号是否正确
//		System.out.println("telephoneIsOk is " + telephoneIsOk);
//		Assert.assertTrue(telephoneIsOk==false);
//	}
//	@Test
